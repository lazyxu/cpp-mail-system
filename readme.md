```
测试账号：
q1051814353@qq.com  q1051814353
qqq1051814353@qq.com  qqq1051814353

修改了list接收信息过长的bug，本来想显示收信的进度表示，结果似乎是qt自动优化了

还未完成
1.乱码原因是莫名多出了0x03 0x0a等字符
2.系统退信内容还不能正常显示
3.收信中如果图片是网上的不能正常显示
4.只能登录非ssl加密的邮箱，ssl加密的邮箱如qq gmail不能登录
