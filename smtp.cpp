...
bool smtp::bfLoginSmtp(bool bIsDebug)
{
	...
	if ( bIsDebug ) if ( bIsDebug ) std::cout<< "Client : connected! \nServer :"
	...
	sockSendMail.send_socket(pcfBase64Encode(strMailPassword.c_str()));// 授权码 "cTEwNTE4MTQzNTM="
	sockSendMail.send_socket("\r\n");
	sockSendMail.recv_socket();
...
bool smtp::bfSendMail(string strFromName, string strToMailAddress, string strTitle, string strContent, bool bIsDebug)
{
